...
function HorizontalDivider() {
  return (
    <div
      ...
      style={{
        background:
          "linear-gradient(90deg, rgba(13, 77, 161, 0) 0%, rgba(13, 77, 161, 0.5) 50%, rgba(13, 77, 161, 0) 100%)",
      }}
    />
  );
}
...
function VerticalDivider() {
  return (
    <div
      ...
      style={{
        background:
          "linear-gradient(180deg, rgba(13, 77, 161, 0) 0%, rgba(13, 77, 161, 0.5) 50%, rgba(13, 77, 161, 0) 100%)",
      }}
    />
  );
}
...
export default function Highlight({
  ...
  return (
    <section className="w-full bg-secondary py-10 md:py-16 overflow-hidden">
      <div className="max-w-[1034px] mx-auto px-4 lg:px-8">
        {/* Header */}
        <motion.div
        ...
        >
          <Heading weight="normal">{sectionTitle}</Heading>
          {sectionDescription && (
            <Paragraph className="text-center">{sectionDescription}</Paragraph>
          )}
        </motion.div>
                ...
                {row.map((item, colIndex) => (
                  <React.Fragment key={colIndex}>
                    ...
                    <motion.div
                      ...
                      transition={{
                        duration: 0.5,
                        delay: (rowIndex * 3 + colIndex) * 0.07,
                      }}
                      className="flex-1 flex flex-col items-center text-center px-4 py-6 md:py-14 hover:bg-white transition-colors duration-300"
                    >
                      {colIndex > 0 && (
                        <div
